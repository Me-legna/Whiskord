...
export const editChannel = (serverId, channelId, updatedChannel) => async (dispatch) => {
...
export const getChannelMembers = (serverId, channelId) => async (dispatch) => {
    const response = await fetch(`/api/servers/${serverId}/channels/${channelId}/members`, {
        headers: {
            'Content-Type': 'application/json'
        }
    });
...
export const addChannelMember = (serverId, channelId, userId) => async (dispatch) => {
    const response = await fetch(`/api/servers/${serverId}/channels/${channelId}/members/${userId}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
...
export const deleteChannelMember = (serverId, channelId, userId) => async (dispatch) => {
    const response = await fetch(`/api/servers/${serverId}/channels/${channelId}/members/${userId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
        ...
        case DELETE_CHANNEL:
            ...
            return {
                ...
                channels: {
                    ...
                    allIds: newState.channels.allIds.filter(id => id !== deletedChannel.id)
                }
            }
