...
def seed_messages():
    ...
    db.session.add_all([thor_message1, thor_message2, thor_message3, thor_message4, thor_message5, thor_message6])
    db.session.add_all([flash_message1, flash_message2, flash_message3, flash_message4, flash_message5, flash_message6, flash_message7, flash_message8])
    db.session.add_all([avenger_message1, avenger_message2, avenger_message3, avenger_message4, avenger_message5, avenger_message6, avenger_message7, avenger_message8, avenger_message9])
